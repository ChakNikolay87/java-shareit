...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleValidationErrors(MethodArgumentNotValidException ex) {
        ...
        log.error("Ошибка валидации: {}", errors.toString());
    ...
    public ResponseEntity<ErrorResponse> handleCommentNotFound(CommentNotFoundException ex) {
        log.error("Ошибка: комментарий не найден - {}", ex.getMessage());
        return new ResponseEntity<>(new ErrorResponse(ex.getMessage()), HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<ErrorResponse> handleBookingAccessException(BookingAccessException ex) {
        log.error("Ошибка доступа к бронированию - {}", ex.getMessage());
