...
public class ItemServiceImpl implements ItemService {
    ...
    public List<ItemWithDateDto> getItemsByOwner(Long ownerId) {
        ...
        List<BookingItemDto> lastBookings = itemRepository.findLastBookings(itemIds, now);
        List<BookingItemDto> nextBookings = itemRepository.findNextBookings(itemIds, now);

        Map<Long, LocalDateTime> lastBookingMap = lastBookings.stream()
                .collect(Collectors.toMap(BookingItemDto::getItemId, BookingItemDto::getStartDate));
